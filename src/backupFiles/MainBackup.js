...
import "../App.css";
import questionsData from "../component/QuestionsData";
import recommendedProducts from "../component/RecommendedProducts";
import longevit from "../assets/longevit.jpg";
      ...
      <div className="wrapperBottom">
        <div className="wrapperBottomImage">
          ...
          <div className="foreground">
            <img alt="" role="presentation" src={longevit} />
          </div>
          <div className="icon1">
            <span className="icon">
    ...
    if (recommendedProduct) {
      return (
        <div className="recommended-product">
          <h2>
            "Congratulations on completing the assessment! You're on the path to
          ...
          <div className="questionnaire-wrapper">
            ...
            <div className="wrapperBottom">
              <div className="questionnaire-progress">
                <div className="progress-wrapper">
                  <progress
                    ...
                    value={(currentQuestion - 1) * (100 / questionsData.length)}
                  >
              ...
              <div className="continue">
                <button
                  onClick={() => {
                    if (currentQuestion < questionsData.length && isAnswered) {
                      handleNextQuestion();
                    } else if (
...
// Export the Questionnaire component
